...
* show check results renderer, expected group ([ee6a785](https://github.com/omniboard-dev/analyzer/commit/ee6a78510f90643c3cabbc4aa4f6c87b8d959343))

### [3.5.1](https://github.com/omniboard-dev/analyzer/compare/v3.5.0...v3.5.1) (2026-08-05)


### Bug Fixes

* git cwd resolution ([7ae1159](https://github.com/omniboard-dev/analyzer/commit/7ae115996626f07c12459d8a6df357e195f78008))

## [3.5.0](https://github.com/omniboard-dev/analyzer/compare/v3.4.0...v3.5.0) (2026-08-05)


### Features

* additional analyzer telemetry ([a29b13b](https://github.com/omniboard-dev/analyzer/commit/a29b13bed4c41ede05baa67b3835d5112470ba0f))

## [3.4.0](https://github.com/omniboard-dev/analyzer/compare/v3.3.0...v3.4.0) (2026-08-05)


### Features

* skip unchanged projects ([bb3777f](https://github.com/omniboard-dev/analyzer/commit/bb3777fb998db7eac7b6b8f2e4bef7ee97e1a84f))
...
* improved project name and duration for handled check failures ([7a5c5e8](https://github.com/omniboard-dev/analyzer/commit/7a5c5e8eefc35e81effea649edc3e7569f93fa41))

### [3.1.1](https://github.com/omniboard-dev/analyzer/compare/v3.1.0...v3.1.1) (2026-08-05)


### Bug Fixes

* print project name ad duration for handled check failures ([495477f](https://github.com/omniboard-dev/analyzer/commit/495477ff748e903536739f13e18cf9be079079c6))
...
* skip blocklisted projects, instead of failing ([ac497ca](https://github.com/omniboard-dev/analyzer/commit/ac497cab300fc7891cc94fd34e816d634debef92))
...
* robustness if team resolver was not defined ([674d346](https://github.com/omniboard-dev/analyzer/commit/674d346af5b24c7d41c47e8d3feb1e43c39ae8be))
...
* optional team resolvers ([37e7112](https://github.com/omniboard-dev/analyzer/commit/37e7112fb21b380926f89da81a81e053fc059156))

## [2.32.0](https://github.com/omniboard-dev/analyzer/compare/v2.31.0...v2.32.0) (2026-04-13)


### Features

* check defaults from organization settings ([4aed656](https://github.com/omniboard-dev/analyzer/commit/4aed656b08acd8336dc8994a25f8126e438545fa))
...
* github actions release pipeline for binary releases ([55dbfaf](https://github.com/omniboard-dev/analyzer/commit/55dbfaf7ead606b9b8e1c6913a3e1e2e52f8f7ff))

### [2.29.2](https://github.com/omniboard-dev/analyzer/compare/v2.29.1...v2.29.2) (2026-02-16)


### Bug Fixes

* github actions release pipeline for binary releases ([57268b6](https://github.com/omniboard-dev/analyzer/commit/57268b6cb50363f9ed823d4e1e3fb78a460a4839))

### [2.29.1](https://github.com/omniboard-dev/analyzer/compare/v2.29.0...v2.29.1) (2026-02-16)

## [2.29.0](https://github.com/omniboard-dev/analyzer/compare/v2.28.0...v2.29.0) (2025-11-10)


### Features

* add per check approx size for results ([09672bd](https://github.com/omniboard-dev/analyzer/commit/09672bd7c3e7ed4b8d5dc355f0bc1c0daa76e535))
